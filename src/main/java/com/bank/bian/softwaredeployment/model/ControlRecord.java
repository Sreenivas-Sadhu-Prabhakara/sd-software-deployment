package com.bank.bian.softwaredeployment.model;
...
/**
 * The BIAN control record for this service domain: "Software Release Procedure".
 *
 ...
 * to its asset type (Software Release). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Software Release Procedure";
